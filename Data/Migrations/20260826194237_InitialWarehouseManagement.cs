...
{
    /// <inheritdoc />
    public partial class InitialWarehouseManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockMovements_WarehouseLocations_FromWarehouseLocationId",
                        column: x => x.FromWarehouseLocationId,
                        principalTable: "WarehouseLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockMovements_WarehouseLocations_ToWarehouseLocationId",
                        column: x => x.ToWarehouseLocationId,
                        principalTable: "WarehouseLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_FromWarehouseLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_ToWarehouseLocationId",
                table: "StockMovements",
                column: "ToWarehouseLocationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocks_ProductId_WarehouseLocationId",
                table: "Stocks",
