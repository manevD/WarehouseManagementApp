...
namespace WarehouseManagement.Migrations
{
    ...
    public partial class Inventory : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryItems_WarehouseLocations_WarehouseLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_InventoryId_ProductId_WarehouseLocationId",
                table: "InventoryItems",
                columns: new[] { "InventoryId", "ProductId", "WarehouseLocationId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_WarehouseLocationId",
                table: "InventoryItems",
